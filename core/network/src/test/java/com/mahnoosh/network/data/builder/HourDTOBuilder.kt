...
internal class HourDTOBuilder {
    private var timeEpoch: Int? = 1700000000
    private var time: String? = "2024-11-25 12:00"
    private var tempC: Double? = 15.0
    private var tempF: Double? = 59.0
    ...
    private var willItRain: Int? = 0
    private var chanceOfRain: Int? = 0
    private var willItSnow: Int? = 0
    private var chanceOfSnow: Int? = 0
    ...
    fun withTimeEpoch(timeEpoch: Int?) = apply { this.timeEpoch = timeEpoch }
    fun withTime(time: String?) = apply { this.time = time }
    ...
    fun withCondition(block: ConditionDTOBuilder.() -> Unit) = apply { this.conditionBuilder.apply(block) }
    ...
    fun withSnowCm(snowCm: Int?) = apply { this.snowCm = snowCm }
    ...
    fun withWillItRain(willItRain: Int?) = apply { this.willItRain = willItRain }
    fun withChanceOfRain(chanceOfRain: Int?) = apply { this.chanceOfRain = chanceOfRain }
    fun withWillItSnow(willItSnow: Int?) = apply { this.willItSnow = willItSnow }
    fun withChanceOfSnow(chanceOfSnow: Int?) = apply { this.chanceOfSnow = chanceOfSnow }
